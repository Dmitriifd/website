(() => {
    ...
    (() => {
        ...
        function rangeInit() {
            ...
            if (priceSlider) {
                const nonLinearStepSliderValueElement = document.getElementById("slider-value");
                ...
                priceSlider.noUiSlider.on("update", (function(values) {
                    ...
                    value[1] < 1e3 ? nonLinearStepSliderValueElement.innerHTML = value.join(" - ") + "т" : nonLinearStepSliderValueElement.innerHTML = value.join(" - ") + "м";
                }));
            }
            if (sliderSum) {
            ...
            if (sliderTime) {
                ...
                pips = sliderTime.querySelectorAll(".noUi-value");
                function clickOnPip() {
                    var value = Number(this.getAttribute("data-value"));
        ...
        function initSliders() {
            if (document.querySelector(".promo-slider")) new core(".promo-slider", {
            ...
            if (document.querySelector(".offer__slider-spec")) new core(".offer__slider-spec", {
                modules: [ Navigation ],
                navigation: {
        ...
        menuIcon.addEventListener("click", (() => {
            ...
            if (hamburgerMenu.classList.contains("active")) document.body.style.overflow = "hidden"; else document.body.style.overflow = "";
        }));
        ...
        cardParent.addEventListener("click", (({target}) => {
            if (target && target.classList.contains("card-review__button")) cardText.forEach(((item, i) => {
